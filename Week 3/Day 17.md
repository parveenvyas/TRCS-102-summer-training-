...
### 💡 Key Takeaways from Day 17:
 1. **Unsupervised Learning:** Crucial for identifying hidden structures, groupings, and patterns when target labels are unavailable.
 2. **Feature Scaling:** Essential before running clustering algorithms so that magnitude differences across features don't distort distance metrics.
 3. **K-Means Algorithm:** An intuitive centroid-based iterative method that efficiently partitions data into distinct, non-overlapping clusters.
 4. 
